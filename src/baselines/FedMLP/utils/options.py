...
def args_parser():
    ...
    parser.add_argument('--test_set', type=str, default='both', choices=['offsite', 'onsite', 'both'], help='which test set')
    parser.add_argument('--atp_data_dir', type=str, default='', help='ATP corruption pickle directory')
    parser.add_argument('--atp_partition_dir', type=str, default='', help='ATP partition pickle directory')
    parser.add_argument('--atp_corruption_file', type=str, default='client_5_partition_step_2_16_corruption_ood_seed_0.pkl', help='ATP corruption pickle filename')
    parser.add_argument('--atp_partition_file', type=str, default='client_5_partition_step_2_16_seed_0.pkl', help='ATP partition pickle filename')
    parser.add_argument('--corruption_std', type=float, default=0.0, help='Gaussian noise std for test corruption (0=off)')
    ...
    parser.add_argument('--label_txt', type=str, default='', help='path to label txt for ODIR')
    parser.add_argument('--data_dir', type=str, default='', help='root data dir for ODIR images')
