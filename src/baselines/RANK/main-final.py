...
if __name__ == '__main__':
    ...
    lr_list = [1e-1]
    alpha_list = [1e0]# 1e0 for corel5k espgame iaprtc12, 1e-1 for others
    beta_list = [0.97]  
    gamma_list = [1e-1]
    sigma_list = [0] #0 for corel5k and pascal07; 0.5 for espgame and iaprtc12; 0.5/1 for mirflickr
    if args.lr >= 0.01:
