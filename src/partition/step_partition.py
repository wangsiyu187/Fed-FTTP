...
def step_partition(dataset, num_labels, num_clients, num_major, alpha):
    ...
    if num_clients == 300 and num_labels == 10 and num_major == 2:  # CIFAR-10 experiments
    ...
    elif num_labels == 8 and num_major == 2:  # ODIR experiments (generalized for any num_clients)
        ...
        raise NotImplementedError(
            f"No partition rule for num_clients={num_clients}, "
            f"num_labels={num_labels}, num_major={num_major}"
        )
