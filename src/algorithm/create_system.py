...
def create_system(train_datasets, test_datasets, args):
    ...
    if algorithm == 'central':
        ...
        server = FedProxServer(train_datasets, test_datasets, args)
    elif algorithm == 'fedbn':
        server = FedBNServer(train_datasets, test_datasets, args)
    elif algorithm == 'scaffold':
        server = SCAFFOLDServer(train_datasets, test_datasets, args)
    elif algorithm == 'perfedavg':
        server = PerFedAvgServer(train_datasets, test_datasets, args)
